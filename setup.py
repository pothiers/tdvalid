#! /usr/bin/env python3
"""Install tdvalid: Various data validation for TADA and related"""
...
long_description="Validate TADA related data files."

with open(path.join(here,'tdvalid','VERSION')) as version_file:
...
setup(
    ...
    url='https://github.com/pothiers/tdvalid',
